 ...
 */
public class TeraSortContainer7 implements IContainer {
    private static final Logger LOG = Logger.
            getLogger(TeraSortContainer7.class.getName());
    private String inputFolder;
    private String filePrefix;
    private String outputFolder;
    private int maxRecordsInMemory;
    private int maxRecordsInQueue;
    ...
    public void init(Config cfg, int containerId, ResourcePlan plan) {
        ...
        maxRecordsInQueue = cfg.getIntegerValue("maxRecordsInQueue", 100000);
        dataQueue = new LinkedBlockingDeque<>(maxRecordsInQueue);
