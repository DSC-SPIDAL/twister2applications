...
public class ReduceExecutor implements Runnable {
  ...
  public ReduceExecutor(int executorId, boolean workerProgress, boolean ackProgress,
                        PartitionSource source, SecondBolt secondBolt, JobParameters jobParameters) {
    this.source = source;
