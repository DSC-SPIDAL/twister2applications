...
public class StockAnalysisConstants {
  ...
  public static final String DINPUT_FILE = "inputfile"; //for stockanalysis
  public static final String DOUTPUT_DIRECTORY = "outputfile";
  ...
  protected StockAnalysisConstants() {
  }
}
